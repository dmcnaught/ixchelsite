...
function getSeason(date) {
    ...
    if (year >= 2027) {
        ...
        if ((month === 12 && day >= 21) || (month === 1 && day <= 2)) return 13;
        if ((month === 1 && day >= 3) || (month >= 2 && month <= 4)) return 9;
        if (month >= 5 && month <= 8) return 10;
        if (month >= 9 && month <= 10) return 11;
        if (month === 11 || (month === 12 && day <= 20)) return 12;
        return 9;
    }
